...
The data collected by the stat must be inside the out_data in the format out_data[table][key]
So for example you can add to the cpu table in influx by having out_data["cpu"][custom_value]
